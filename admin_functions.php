...
<p class="mdx-admin-img"><img src="' . esc_url(get_template_directory_uri().'/img/admin.jpg') . '"></p>
...
<p style="font-size:15px;">'.__('这个项目的 Github 地址是 ', 'mdx').'<a href="https://github.com/daxiaamu/mdx" target="_blank">github.com/daxiaamu/mdx</a>'.__('。如果你有兴趣，欢迎为这个项目做出贡献。同时，求 Star。', 'mdx').'</p>
